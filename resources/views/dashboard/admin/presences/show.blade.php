    ...
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative rounded-lg shadow" style="background-color: var(--cine-surface) !important; border: 1px solid var(--cine-border) !important;">
            <div class="flex items-start justify-between p-4 border-b rounded-t" style="border-color: var(--cine-border) !important;">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:text-white rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center" data-modal-hide="scannerModal">
            ...
            <div class="p-6 space-y-6">
                <!-- Wrapper khusus untuk menampung styling native qr-code reader tanpa bergantung pada letak parent class -->
                <div id="reader-wrapper" style="--text: #f0f0f0; --link: #62a1db; --btn-bg: #101924; --btn-br: #1c2b3d; --btn-hover: #1a2838; color: var(--text);">
                    <div id="reader"></div>
                </div>
            </div>
        </div>
