...
<nav class="hidden lg:block absolute bg-transparent w-full z-40">
    ...
    <div class="hidden mobile-menu">
        <ul>
            ...
            @auth
                <li><a href="{{ route('home-presences.indexuserdashboard') }}" class="block {{ request()->is('login') ? 'text-sm px-2 py-4 font-sans font-normal text-white bg-primary hover:bg-white transition duration-500' : 'text-sm px-2 py-4 font-sans font-normal text-gray-600 hover:text-white hover:bg-white transition duration-500' }}">Dashboard</a></li>
            @else
                <li><a href="https://peserta-pkkmb.narotama.ac.id/auth" class="block {{ request()->is('login') ? 'text-sm px-2 py-4 font-sans font-normal text-white bg-primary hover:bg-white transition duration-500' : 'text-sm px-2 py-4 font-sans font-normal text-gray-600 hover:text-white hover:bg-white transition duration-500' }}">Login</a></li>
            @endauth
        </ul>
    </div>
</nav>