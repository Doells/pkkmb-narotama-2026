...
<head>
    ...
    <title>Login | PKKMB Narotama 2026</title>
    ...
    <main class="cine-login-page">
        ...
        <section class="cine-login-panel">
            <div class="cine-login-box">
                ...
                <div class="cine-login-title"><small>SELAMAT DATANG</small><h2>Login</h2><p>Gunakan NIM dan kata sandi yang telah diberikan oleh panitia.</p></div>
