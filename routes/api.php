...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::middleware(['role:admin,superadmin'])->group(function() {
        ...
        Route::delete('/dashboard/admin/news/delete/{id_berita}', [NewsController::class, 'destroy'])->name('news.destroy');

        //Jenis Ketentuan
        Route::get('/dashboard/admin/jenis-ketentuan', [JenisKetentuanController::class, 'index'])->name('jenisketentuan.index');
        Route::post('/dashboard/admin/jenis-ketentuan/store', [JenisKetentuanController::class, 'store'])->name('jenisketentuan.store');
        Route::post('/dashboard/admin/jenis-ketentuan/update', [JenisKetentuanController::class, 'update'])->name('jenisketentuan.update');
        Route::delete('/dashboard/admin/jenis-ketentuan/delete/{id_jenis_ketentuan}', [JenisKetentuanController::class, 'destroy'])->name('jenisketentuan.destroy');
        ...
        Route::delete('/dashboard/admin/ketentuan/delete/{id_ketentuan}', [KetentuanController::class, 'destroy'])->name('ketentuan.destroy');
        ...
        Route::delete('/dashboard/admin/pelanggaran/delete/{id_pelanggaran}', [PelanggaranController::class, 'destroy'])->name('pelanggaran.destroy');
    ...
    /* User (All Roles) */
    Route::get('/dashboard/user/presensi', [HomePresenceController::class, 'index'])->name('home.index');
    ...
    Route::get('/dashboard/user/presensi/{attendance}', [HomePresenceController::class, 'show'])->name('home.show');
